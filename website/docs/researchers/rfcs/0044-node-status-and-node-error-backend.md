---
format: md
title: "RFC 0044: Node Status And Node Error Backend"
sidebar_label: "0044 Node Status And Node Error Backend"
hide_table_of_contents: false
---

> **Original source:**
> [0044-node-status-and-node-error-backend.md](https://github.com/MinaProtocol/mina/blob/compatible/rfcs/0044-node-status-and-node-error-backend.md)
