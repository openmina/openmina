---
format: md
title: "RFC 0032: Automated Validation"
sidebar_label: "0032 Automated Validation"
hide_table_of_contents: false
---

> **Original source:**
> [0032-automated-validation.md](https://github.com/MinaProtocol/mina/blob/compatible/rfcs/0032-automated-validation.md)
...
Providers provide network state to the rest of the system. There are multiple
...
unifies the entire concurrency model into one abstraction (processes),
