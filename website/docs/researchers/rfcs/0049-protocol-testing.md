---
format: md
title: "RFC 0049: Protocol Testing"
sidebar_label: "0049 Protocol Testing"
hide_table_of_contents: false
---

> **Original source:**
> [0049-protocol-testing.md](https://github.com/MinaProtocol/mina/blob/compatible/rfcs/0049-protocol-testing.md)
...
As an example query, let's say we wanted to validate a branch that intends to
...
Kubernetes based backend allows us to write 1 backend and run both live in the
...
[Test DSL Specification](https://github.com/MinaProtocol/mina/blob/compatible/docs/test_dsl_spec.md)
