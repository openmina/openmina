---
format: md
title: "RFC 0060: Networking Refactor"
sidebar_label: "0060 Networking Refactor"
hide_table_of_contents: false
---

> **Original source:**
> [0060-networking-refactor.md](https://github.com/MinaProtocol/mina/blob/compatible/rfcs/0060-networking-refactor.md)
...
NOTE: The scope of the design discussed in this document is the full refactor,
...
CONSIDER: Is it important that IPC messages include timestamps so that the
...
Here is a list of the IPC messages that will be supported in each direction,
...
purposes. We will continue to have an
[interface](https://github.com/MinaProtocol/mina/blob/compatible/src/lib/gossip_net/intf.ml)
along with a
[existential wrapper](https://github.com/MinaProtocol/mina/blob/compatible/src/lib/gossip_net/any.ml)
that provides indirection over the selected gossip network implementation. A
[stub implementation](https://github.com/MinaProtocol/mina/blob/compatible/src/lib/gossip_net/fake.ml)
...
[current GADT based setup](https://github.com/MinaProtocol/mina/blob/compatible/src/lib/mina_networking/mina_networking.ml).
...
[Mina_lib](https://github.com/MinaProtocol/mina/blob/compatible/src/lib/mina_lib/mina_lib.ml)
...
- Unix sockets could be an alternative to Unix pipes
  ...
  - with the data stream generalization, we can always swap this in if and when
    we decide to move processes around
