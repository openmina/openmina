...
description: Mina Schnorr Signatures specification for the Pallas elliptic curve
slug: /researchers/specs/schnorr-signatures
---
...
[MinaProtocol/mina](https://github.com/MinaProtocol/mina) repository,
`compatible` branch, commit
[`217c823fb14d4c8b08ceba0404c5b8a624e90e14`](https://github.com/MinaProtocol/mina/blob/217c823fb14d4c8b08ceba0404c5b8a624e90e14/docs/specs/signatures/description.md).
...
- December 2021, Joseph Spadavecchia (joseph@o1labs.org) Updated to latest
  curves and signing algorithm
...
- To sign _`m`_ for public key _`P = dG`_:
  ...
  - Let _`R = [k]G`_
  - If _`odd(y(R))`_ then _`negate(k)`_
