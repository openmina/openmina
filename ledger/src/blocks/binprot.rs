...
impl Serialize for ByteString {
        ...
        S: serde::Serializer,
    {
        ...
        // let a = serializer.serialize_u64(self.0.len() as u64)?;
        // a.serialize_bytes(&self.0)
        serializer.serialize_str(&hex::encode(&self.0)) // TODO: Fix this
    }
}
...
mod tests {
    ...
    fn test_serialize_messages_for_next_step_proof() {
        for _ in 0..1000000 {
            ...
            println!("hash computed");

            let bytes = serde_binprot::to_vec(&msg).unwrap();
            println!("msg serialized");
            let msg2: MessagesForNextStepProof = serde_binprot::from_slice(&bytes).unwrap();
