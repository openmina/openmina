...
// pub type ByteString = BigInt;

/// String of bytes.
#[derive(Clone, Debug, PartialEq, Eq, PartialOrd, Ord)]
pub struct ByteString(Vec<u8>);

// impl From<ByteString> for Fp {
//     fn from(value: ByteString) -> Self {
//         println!("LEN={:?} V={:?}", value.0.len(), value.0);
//         let bigint = BigInt(value.0.try_into().unwrap());
//         println!("BIGINT=  {:?}", bigint.0);
//         let v = bigint.into();
//         println!("OK");
//         v
//     }
