...
use crate::{
    ...
    Account, AuthRequired, ControlTag, Mask, ReceiptChainHash, TokenId, ZkAppAccount,
};
...
//                 );
//                 if is_start_ {
//                     (tx_commitment_on_start.0, full_tx_commitment_on_start.0)
//                 } else {
//                     (
//                         local_state.transaction_commitment,
//                         local_state.full_transaction_commitment,
...
//                     ReceiptChainHash(local_state.full_transaction_commitment.clone()),
//                 );
