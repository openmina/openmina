...
impl From<P2pChannelsStreamingRpcEffectfulAction> for crate::P2pEffectfulAction {
    fn from(a: P2pChannelsStreamingRpcEffectfulAction) -> crate::P2pEffectfulAction {
        crate::P2pEffectfulAction::Channels(P2pChannelsEffectfulAction::StreamingRpc(a))
    }
}
