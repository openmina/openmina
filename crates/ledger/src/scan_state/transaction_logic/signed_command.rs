...
///
/// OCaml: <https://github.com/MinaProtocol/mina/blob/5da42ccd72e791f164d4d200cf1ce300262873b3/src/lib/mina_base/signed_command_payload.ml#L34-L48>
...
///
/// OCaml: <https://github.com/MinaProtocol/mina/blob/5da42ccd72e791f164d4d200cf1ce300262873b3/src/lib/mina_base/stake_delegation.ml#L11-L13>
#[derive(Debug, Clone, PartialEq, Eq)]
...
impl StakeDelegationPayload {
    /// OCaml: <https://github.com/MinaProtocol/mina/blob/5da42ccd72e791f164d4d200cf1ce300262873b3/src/lib/mina_base/stake_delegation.ml#L35-L37>
    pub fn receiver(&self) -> AccountId {
        let Self::SetDelegate { new_delegate } = self;
        AccountId::new(new_delegate.clone(), TokenId::default())
    }

    /// OCaml: <https://github.com/MinaProtocol/mina/blob/5da42ccd72e791f164d4d200cf1ce300262873b3/src/lib/mina_base/stake_delegation.ml#L33-L33>
...
/// delegation.
///
/// OCaml: <https://github.com/MinaProtocol/mina/blob/5da42ccd72e791f164d4d200cf1ce300262873b3/src/lib/mina_base/signed_command_payload.ml#L179-L181>
#[derive(Debug, Clone, PartialEq, Eq)]
pub enum Body {
...
///
/// OCaml: <https://github.com/MinaProtocol/mina/blob/5da42ccd72e791f164d4d200cf1ce300262873b3/src/lib/mina_base/signed_command_payload.ml#L239-L243>
#[derive(Debug, Clone, PartialEq)]
...
impl SignedCommand {
    ...
    /// OCaml: <https://github.com/MinaProtocol/mina/blob/5da42ccd72e791f164d4d200cf1ce300262873b3/src/lib/mina_base/signed_command_payload.ml#L292-L292>
    ...
    /// OCaml: <https://github.com/MinaProtocol/mina/blob/5da42ccd72e791f164d4d200cf1ce300262873b3/src/lib/mina_base/signed_command_payload.ml#L290-L290>
    ...
    /// OCaml: <https://github.com/MinaProtocol/mina/blob/5da42ccd72e791f164d4d200cf1ce300262873b3/src/lib/mina_base/signed_command_payload.ml#L288-L288>
    ...
    /// OCaml: <https://github.com/MinaProtocol/mina/blob/5da42ccd72e791f164d4d200cf1ce300262873b3/src/lib/mina_base/signed_command_payload.ml#L304-L304>
    pub fn receiver(&self) -> AccountId {
    ...
    /// OCaml: <https://github.com/MinaProtocol/mina/blob/5da42ccd72e791f164d4d200cf1ce300262873b3/src/lib/mina_base/signed_command_payload.ml#L302-L302>
    pub fn receiver_pk(&self) -> &CompressedPubKey {
        match &self.payload.body {
    ...
    /// OCaml: <https://github.com/MinaProtocol/mina/blob/5da42ccd72e791f164d4d200cf1ce300262873b3/src/lib/mina_base/signed_command_payload.ml#L320-L338>
    ...
    /// OCaml: <https://github.com/MinaProtocol/mina/blob/5da42ccd72e791f164d4d200cf1ce300262873b3/src/lib/mina_base/signed_command.ml#L417-L420>
    pub fn public_keys(&self) -> [&CompressedPubKey; 2] {
        [self.fee_payer_pk(), self.receiver_pk()]
    }

    /// OCaml: <https://github.com/MinaProtocol/mina/blob/5da42ccd72e791f164d4d200cf1ce300262873b3/src/lib/mina_base/signed_command.ml#L422-L424>
