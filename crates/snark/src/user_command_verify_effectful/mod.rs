...
impl mina_core::requests::RequestIdType for SnarkUserCommandVerifyIdType {
    fn request_id_type() -> &'static str {
        "SnarkUserCommandVerifyId"
    }
}

pub type SnarkUserCommandVerifyId = mina_core::requests::RequestId<SnarkUserCommandVerifyIdType>;
