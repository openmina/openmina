...
export class DashboardSplitsSidePanelTableComponent
  extends MinaTableRustWrapper<DashboardSplitsPeer>
  implements OnInit
{
  ...
  override async ngOnInit(): Promise<void> {
    this.height = isDesktop()
      ? (this.peers.length + 1) * 36 + 1
      : this.peers.length * 104 + 90;
