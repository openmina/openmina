...
export const NETWORK_BOOTSTRAP_STATS_INIT =
  NetworkBootstrapStatsActionTypes.NETWORK_BOOTSTRAP_STATS_INIT;
export const NETWORK_BOOTSTRAP_STATS_CLOSE =
  NetworkBootstrapStatsActionTypes.NETWORK_BOOTSTRAP_STATS_CLOSE;
export const NETWORK_BOOTSTRAP_STATS_GET_BOOTSTRAP_STATS =
  NetworkBootstrapStatsActionTypes.NETWORK_BOOTSTRAP_STATS_GET_BOOTSTRAP_STATS;
export const NETWORK_BOOTSTRAP_STATS_GET_BOOTSTRAP_STATS_SUCCESS =
  NetworkBootstrapStatsActionTypes.NETWORK_BOOTSTRAP_STATS_GET_BOOTSTRAP_STATS_SUCCESS;
export const NETWORK_BOOTSTRAP_STATS_SET_ACTIVE_BOOTSTRAP_REQUEST =
  NetworkBootstrapStatsActionTypes.NETWORK_BOOTSTRAP_STATS_SET_ACTIVE_BOOTSTRAP_REQUEST;
