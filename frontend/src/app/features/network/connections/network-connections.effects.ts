  ...
  constructor(
    ...
    this.init$ = createEffect(() =>
      this.actions$.pipe(
        ...
        this.latestStateSlice<NetworkConnectionsState, NetworkConnectionsInit>(
          'network.connections',
        ),
    ...
    this.getConnections$ = createEffect(() =>
      this.actions$.pipe(
        ofType(
          NETWORK_CONNECTIONS_GET_CONNECTIONS,
          NETWORK_CONNECTIONS_GO_LIVE,
        ...
        this.latestActionState<
          NetworkConnectionsGetConnections | NetworkConnectionsGoLive
        >(),
        tap(
          ({ state }) => (this.streamActive = state.network.connections.stream),
        ),
        ...
        map((payload: NetworkConnection[]) => ({
          type: NETWORK_CONNECTIONS_GET_CONNECTIONS_SUCCESS,
          payload,
        })),
        catchErrorAndRepeat(
