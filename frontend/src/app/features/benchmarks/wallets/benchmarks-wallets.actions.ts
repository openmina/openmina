...
export const BENCHMARKS_WALLETS_CLOSE =
  BenchmarksWalletsActionTypes.BENCHMARKS_WALLETS_CLOSE;
export const BENCHMARKS_WALLETS_GET_WALLETS =
  BenchmarksWalletsActionTypes.BENCHMARKS_WALLETS_GET_WALLETS;
export const BENCHMARKS_WALLETS_GET_WALLETS_SUCCESS =
  BenchmarksWalletsActionTypes.BENCHMARKS_WALLETS_GET_WALLETS_SUCCESS;
export const BENCHMARKS_WALLETS_UPDATE_WALLETS_SUCCESS =
  BenchmarksWalletsActionTypes.BENCHMARKS_WALLETS_UPDATE_WALLETS_SUCCESS;
export const BENCHMARKS_WALLETS_CHANGE_TRANSACTION_BATCH =
  BenchmarksWalletsActionTypes.BENCHMARKS_WALLETS_CHANGE_TRANSACTION_BATCH;
export const BENCHMARKS_WALLETS_CHANGE_ZKAPPS_BATCH =
  BenchmarksWalletsActionTypes.BENCHMARKS_WALLETS_CHANGE_ZKAPPS_BATCH;
export const BENCHMARKS_WALLETS_SEND_TXS =
  BenchmarksWalletsActionTypes.BENCHMARKS_WALLETS_SEND_TXS;
export const BENCHMARKS_WALLETS_SEND_TX_SUCCESS =
  BenchmarksWalletsActionTypes.BENCHMARKS_WALLETS_SEND_TX_SUCCESS;
export const BENCHMARKS_WALLETS_SEND_ZKAPPS =
  BenchmarksWalletsActionTypes.BENCHMARKS_WALLETS_SEND_ZKAPPS;
export const BENCHMARKS_WALLETS_SEND_ZKAPPS_SUCCESS =
  BenchmarksWalletsActionTypes.BENCHMARKS_WALLETS_SEND_ZKAPPS_SUCCESS;
export const BENCHMARKS_WALLETS_TOGGLE_RANDOM_WALLET =
  BenchmarksWalletsActionTypes.BENCHMARKS_WALLETS_TOGGLE_RANDOM_WALLET;
export const BENCHMARKS_WALLETS_SELECT_WALLET =
  BenchmarksWalletsActionTypes.BENCHMARKS_WALLETS_SELECT_WALLET;
export const BENCHMARKS_WALLETS_CHANGE_AMOUNT =
  BenchmarksWalletsActionTypes.BENCHMARKS_WALLETS_CHANGE_AMOUNT;
export const BENCHMARKS_WALLETS_CHANGE_FEE =
  BenchmarksWalletsActionTypes.BENCHMARKS_WALLETS_CHANGE_FEE;
export const BENCHMARKS_WALLETS_CHANGE_FEE_ZKAPPS =
  BenchmarksWalletsActionTypes.BENCHMARKS_WALLETS_CHANGE_FEE_ZKAPPS;
export const BENCHMARKS_WALLETS_GET_ALL_TXS =
  BenchmarksWalletsActionTypes.BENCHMARKS_WALLETS_GET_ALL_TXS;
...
export class BenchmarksWalletsSendZkAppsSuccess implements BenchmarksWalletsAction {
  ...
  constructor(
    public payload: Partial<{ zkApps: BenchmarksZkapp[]; error: Error }>,
  ) {}
}
