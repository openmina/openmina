...
import { BlockProductionOverviewSidePanelComponent } from '@block-production/overview/side-panel/block-production-overview-side-panel.component';
...
import { BlockProductionOverviewEpochGraphsComponent } from '@block-production/overview/epoch-graphs/block-production-overview-epoch-graphs.component';
import { LoadingSpinnerComponent } from '@shared/loading-spinner/loading-spinner.component';
import { BlockProductionOverviewSlotDetailsComponent } from '@block-production/overview/slot-details/block-production-overview-slot-details.component';
