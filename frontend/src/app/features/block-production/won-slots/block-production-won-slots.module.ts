...
import { BlockProductionWonSlotsTableComponent } from '@block-production/won-slots/table/block-production-won-slots-table.component';
import { BlockProductionWonSlotsSidePanelComponent } from '@block-production/won-slots/side-panel/block-production-won-slots-side-panel.component';
