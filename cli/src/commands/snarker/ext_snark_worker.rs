...
async fn read_snark_work_result<T: BinProtRead, R: AsyncRead + Unpin>(
    mut r: R,
...
pub(super) struct ExternalSnarkWorkerSender {
                ...
                runtime.block_on(async move {
                    ...
                    if let Some(pid) = child.id() {
                        ...
                        tokio::spawn(async move {
                            ...
                            if let Err(err) = write_snark_work_spec(request, &mut child_stdin).await {
                                event(err.into());
                                return;
                            }
...
mod tests {
    ...
    use super::ExternalSnarkWorkerSender;
