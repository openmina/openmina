...
and have the packets sent back. This example could be easily extended to do
...
[jsfiddle.net](https://jsfiddle.net/9jgukzt1/) you should see two text-areas and
...
Your browser should send video to webrtc-rs, and then it will be relayed right
back to you.
