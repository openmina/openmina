...
pub fn empty_block_body() -> v2::StagedLedgerDiffDiffStableV2 {
    use ledger::staged_ledger::diff::with_valid_signatures_and_proofs::Diff;
    (&Diff::empty()).into()
}

pub fn empty_block_body_hash() -> v2::ConsensusBodyReferenceStableV1 {
    use ledger::staged_ledger::validate_block::block_body_hash;
    block_body_hash(&empty_block_body()).unwrap()
}

pub fn empty_pending_coinbase() -> PendingCoinbase {
