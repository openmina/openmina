...
docker build -t vladsimplestakingcom/mina-openmina-builder:focal -f node/testing/docker/Dockerfile.openmina node/testing/docker
docker build -t vladsimplestakingcom/mina-testenv:2.0.0rampup4-focal -f node/testing/docker/Dockerfile.test node/testing/docker
